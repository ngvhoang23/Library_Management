      ...
      _retrieveData("ACCESS_TOKEN")
        .then((access_token) => {
          const config = {
            ...
            params: { reader_id: user.user_id },
          };
          axios
            .get(`http://10.0.2.2:5000/borrowed-books/fine/${user?.user_id}`, config)
            .then((result) => {
      ...
      <View style={styles.container}>
        <RoundUserInfoPreview
          _styles={[
            ...
            { borderColor: total_amount_collected >= total_fine ? "#6ec531" : "#f02849" },
          ]}
